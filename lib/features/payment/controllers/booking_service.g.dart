...
class _BookingService implements BookingService {
  ...
  Future<PaymentUrlResponse> getPaymentUrl(
    ...
    final _options = _setStreamType<PaymentUrlResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payments/url',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaymentUrlResponse _value;
    try {
      _value = PaymentUrlResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<PaymentCallbackResponse> checkPaymentStatus(String orderId) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<dynamic> getPaymentUrlDynamic(PaymentRequest paymentRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
